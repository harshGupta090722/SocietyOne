...
export const tenantVerification = async (req: Request, res: Response): Promise<any> => {
    try {
...
export const getVacantFlats = async (req: Request, res: Response): Promise<any> => {
    try {
...
export const requestRent = async (req: Request, res: Response): Promise<any> => {
    try {
